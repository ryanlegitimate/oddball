...
while True:
    ...
    parameters = [
        ...
        ("Fixation duration (ms)", str(FIXATION_DURATION))  # Added fixation duration
    ]
    ...
    radio_rects = [
        pygame.Rect(WIDTH // 2 - 150, start_y + 5 * spacing + 30, 20, 20),  # Both
        pygame.Rect(WIDTH // 2 - 50, start_y + 5 * spacing + 30, 20, 20),   # Audio
        pygame.Rect(WIDTH // 2 + 50, start_y + 5 * spacing + 30, 20, 20)    # Visual
    ]
    ...
    while entering_params:
        for event in pygame.event.get():
            ...
            if event.type == pygame.VIDEORESIZE:
                ...
                radio_rects = [
                    pygame.Rect(WIDTH // 2 - 150, start_y + 5 * spacing + 30, 20, 20),
                    pygame.Rect(WIDTH // 2 - 50, start_y + 5 * spacing + 30, 20, 20),
                    pygame.Rect(WIDTH // 2 + 50, start_y + 5 * spacing + 30, 20, 20)
                ]
        ...
        screen.blit(stim_type_text, (WIDTH // 2 - stim_type_text.get_width() // 2, start_y + 5 * spacing))
        ...
        screen.blit(instruction_text, (WIDTH // 2 - instruction_text.get_width() // 2, start_y + 6 * spacing + 20))
        pygame.display.flip()
